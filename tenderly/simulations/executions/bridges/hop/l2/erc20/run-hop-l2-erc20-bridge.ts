...
import { simulateBridgeERC20OnHopL2 } from "../../../../../bridges/hop/l2/erc20/simulate-bridge-erc20-hop-l2";

export const executeHopL2ERC20Bridge = async (sourceChain: ChainCodes, destinationChain: ChainCodes, forkBlockNumber: number, sender: string) => {
   ...
   const simulationResponse = await simulateBridgeERC20OnHopL2(forkProvider, fork.forkAtBlockNumber, sourceChain, destinationChain, sender, owner);
