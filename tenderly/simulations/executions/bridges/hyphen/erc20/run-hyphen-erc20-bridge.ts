...
import { simulateBridgeERC20OnHyphen } from "../../../../bridges/hyphen/erc20/simulate-bridge-erc20-hyphen";

export const executeHyphenERC20Bridge = async (sourceChain: ChainCodes, destinationChain: ChainCodes, forkBlockNumber: number, sender: string) => {
   ...
   const simulationResponse = await simulateBridgeERC20OnHyphen(forkProvider, fork.forkAtBlockNumber, sourceChain, destinationChain, sender, owner);
