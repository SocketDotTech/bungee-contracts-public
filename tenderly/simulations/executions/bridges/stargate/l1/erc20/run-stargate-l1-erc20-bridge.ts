...
import { simulateBridgeERC20OnStargateL1 } from "../../../../../bridges/stargate/l1/erc20/simulate-bridge-erc20-stargate-l1";

export const executeStargateL1ERC20Bridge = async (sourceChain: ChainCodes, destinationChain: ChainCodes, forkBlockNumber: number, sender: string) => {
   ...
   const simulationResponse = await simulateBridgeERC20OnStargateL1(forkProvider, fork.forkAtBlockNumber, sourceChain, destinationChain, sender, owner);
