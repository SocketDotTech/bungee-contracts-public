...
contract ERC20ToNativeTest is Test, SocketGatewayBaseTest {
    ...
    function testSwapERC20ToNative() public {
        ...
        bytes memory eventData = abi.encodePacked("zerox", "erc20-native");
        ...
        //Swapped to Native: 0.084 ETH
        assertEq(swappedAmount, 84292878121357568);
