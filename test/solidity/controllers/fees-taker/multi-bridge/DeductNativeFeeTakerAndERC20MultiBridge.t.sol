...
contract DeductNativeFeeTakerAndERC20MultiBridgeTest is
    Test,
    SocketGatewayBaseTest
{
    ...
    function testTakeNativeFeesAndMultiBridge() public {
        ...
        deal(
            integrator,
            nativeArbitrumBridgeRequestData.bridgeValue + feesData.feesAmount
        );
        assertEq(
            integrator.balance,
            nativeArbitrumBridgeRequestData.bridgeValue + feesData.feesAmount
